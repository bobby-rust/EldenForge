...
function App() {
    ...
    // Reroll item reducer
    const rerollReducer = (state: any, action: rerollItemAction) => {
        /**
        ...
        const { id, build, type } = action;

        console.log("You sent me type:", type);
     ...
     * Pass the initialBuildNums numbers here because this is only called when initializing the state
     */
    const [build, buildDispatch] = React.useReducer(
        rerollReducer,
        initialBuild
    );
