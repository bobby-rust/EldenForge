...
export default function IncludePreviouslyRolledMenu(props: any) {
	...
	const categories: string[] = ["Weapons", "Ashes", "Incantations", "Sorceries", "Spirits", "Talismans", "Shields"];
	...
	React.useEffect(() => {
		for (let i = 0; i < category.length; i++) {
			...
			categoriesToIncludePreviouslyRolled[currCat] = !categoriesToIncludePreviouslyRolled[currCat];
		}
